...
import LeafPng from "../../assets/nuts/Leaf.png";
...
py-14 md:py-0 relative z-10">
    ...
    lg:max-w-[400px]">
        ...
        className="text-gray-400">
            Healthy and yummy korosho for fresh morning breakfast. <br/>
            Improves vitality, good source of protein, helps in weight managment
            and is heart friendly.
            </motion.p>
        {/* button section*/}
        <motion.div 
...
<div className="absolute top-14
    md:top-0 right-1/2 opacity-100">
    <motion.img 
    initial={{ opacity: 0, x: -200, rotate: 75 }}
    animate={{ opacity: 1, x: 0, rotate: 0 }}
    ...
    src={LeafPng} 
    alt="" 
    className="w-50 h-50 md:max-w-[300px]" />
