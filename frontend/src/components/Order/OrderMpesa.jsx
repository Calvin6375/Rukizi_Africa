...
const OrderMpesa = () => {
  ...
  try {
    ...
    // Prepare request body with phone_number key
    const requestBody = {
      firstName,
      lastName,
      phone_number: phoneNumber, // changed key here
      email,
      amount: total,
    };
    console.log('Sending payment initiation request with payload:', requestBody);
