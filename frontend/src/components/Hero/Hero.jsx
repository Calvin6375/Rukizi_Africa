...
const Hero = () => {
  ...
  const handleOrderClick = () => {
    navigate('/Menus'); // Navigate to the order page
  };

  const handleDownloadClick = () => {
    const link = document.createElement('a');
    link.href = `${process.env.PUBLIC_URL}/app.apk`; // Use the original file name
        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w-[400px]">
            ...
            >
              ...
              <button 
                className="primary-btn flex items-center gap-2 ml-4" // Add margin for spacing
                onClick={handleDownloadClick} // Add onClick event for download
              >
                Download APK
              </button>
            </motion.div>
